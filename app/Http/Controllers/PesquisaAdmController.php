    ...
    { 
        ...
        for($i=0; $i < count($perguntas); $i++)
        {
            ...
            if($perguntasTipos[$i] == 'checkbox' || $perguntasTipos[$i] == 'radio'){
                ...
                ///////////////////////// TRABALHAR COM ESSE CAMPO: qtdeOpcResp
                ...
                $numStart = (int)$opcoesRespostas[$i];
                $numEnd = count($opcoesRespostas) - 1;
                if($numStart > 0){  $numEnd = (count($opcoesRespostas)-1) - $numStart; }
