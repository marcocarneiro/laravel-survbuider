    ...
    <form>
        ...
        <fieldset class="p-6 mt-8 mb-8 border border-gray-300">            
            <legend class="px-4">
                ...
                <svg wire:click="createPesquisa" onClick="addPerguntas()" class="cursor-pointer inline-block w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
