<div class="w-full xl:w-5/6 p-10 bg-slate-100">
            ...
            <div id="perguntas">
                <div class="pergunta relative mt-6 pb-8 border-b border-gray-300">
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6 gap-2 mb-6">
                        <div>
                            <!-- campos texto da questão e imagem opcional  -->
                        ...
                        <div>
                            ...
                            <fieldset class="resposta-details p-6 mt-8 mb-8 border border-gray-300 hidden">            
                                    ...
                                    <!-- opções de resposta para questões checkbox e radio  -->
                                    <div class="relative opc-resposta">
                                        ...
                                        <svg data-modal-toggle="modal-pergunta" class="absolute right-1 bottom-[10px] cursor-pointer w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
    ...
    <div id="modal-pergunta" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
