        ...
        <nav class="bg-slate-500 fixed text-slate-200 px-2 sm:px-4 py-2.5 w-full drop-shadow-md z-50">
            ...
            <div class="flex items-center md:order-2">
                ...
                <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
                  ...
                  <ul class="py-1" aria-labelledby="dropdown">
                    <li>
                      <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600
                       dark:text-gray-200 dark:hover:text-white">Dashboard</a>
                    </li>
                    <li>
            ...
            <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1" id="mobile-menu-2">
              <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                <li>
                  <a href="{{ route('dashboard') }}" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-200 hover:bg-gray-50 
                  md:hover:bg-transparent md:border-0 md:hover:text-blue-400 md:p-0 dark:text-gray-400
                   md:dark:hover:text-white dark:hover:bg-gray-400 dark:hover:text-white md:dark:hover:bg-transparent
                    dark:border-gray-400">Painel</a>
                </li>
                <li>
                  <a href="{{ route('new-pesquisa') }}" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-200 hover:bg-gray-50 
                  md:hover:bg-transparent md:border-0 md:hover:text-blue-400 md:p-0 dark:text-gray-400
                   md:dark:hover:text-white dark:hover:bg-gray-400 dark:hover:text-white md:dark:hover:bg-transparent
                    dark:border-gray-400">Criar pesquisa</a>
                </li>
                <li>
                  <a href="#" class="block py-2 pr-4 pl-3 text-gray-200 border-b border-gray-200 hover:bg-gray-50 
                  md:hover:bg-transparent md:border-0 md:hover:text-blue-400 md:p-0 dark:text-gray-400
                   md:dark:hover:text-white dark:hover:bg-gray-400 dark:hover:text-white md:dark:hover:bg-transparent
                    dark:border-gray-400">Resultados</a>
                </li>
              </ul>
            </div>
            </div>
